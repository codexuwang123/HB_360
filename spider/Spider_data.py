...
class Spider_desc_360():
    ...
    # 解析主函数
    def spider_360(self, pn, keyword,list_redis,section_name, author):
        ...
        if res.status_code == 200:
            ...
            print(data, len(data))
            format_base_spdb.format_text(first_data=data, keyword=keyword,list_redis=list_redis,section_name=section_name, author=author)
        else:
            print(res.text)
    ...
    if keyword_list:
        ...
        for i in keyword_list:
            ...
            for n in range(1, set_.get('max_page')):
                ...
                spider_self.spider_360(pn=n, keyword=spider_self.wd,list_redis=list_redis,section_name=section_name,author=author_name)
